...
const transactions = [
  { id: 1, type: 'Deposit', amount: '0.5 ETH', date: '2023-06-01', status: 'Completed', link: 'https://etherscan.io/tx/0x123' },
  { id: 2, type: 'Withdrawal', amount: '1.2 ETH', date: '2023-05-28', status: 'Pending', link: 'https://etherscan.io/tx/0x456' },
  { id: 3, type: 'Reward', amount: '0.1 ETH', date: '2023-05-25', status: 'Completed', link: 'https://etherscan.io/tx/0x789' },
          ...
          <tbody>
            {getCurrentTransactions().map((tx) => (
              <tr key={tx.id} className="border-t border-gray-700 text-white">
                ...
                <td className="py-3">
                  <a href={tx.link} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
