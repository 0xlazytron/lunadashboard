    ...
    <footer className="rounded-xl bg-white/10 p-8 backdrop-blur-lg">
      <div className="container mx-auto">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">My Account</h3>
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">Marketplace</h3>
            <ul className="space-y-2 text-sm text-gray-300">
              <li>Explore</li>
              <li>All NFT</li>
              <li>Collectible</li>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-gray-700 pt-8 md:flex-row">
          ...
          <div className="text-sm text-gray-300">2024© Copyright Lunalotto. All Rights Reserved</div>
